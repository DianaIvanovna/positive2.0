...
const Photogallery = ({season}) => {
    ...
    const closePopupEvent = event => {
        if (event.target.classList.contains(popupStyle.popup)) {
            closePopup();
        }
    };
    ...
    return (
        <section className="photogallery">
            ...
            <Popup openPopup={!!bigPhoto.photo} setOpenPopup={closePopup} onClick={closePopupEvent} zIndex={200}>
                <div className="photogallery-popup">
                    <picture className="photogallery-popup__img">
                        <div className={cn(popupStyle.popup__icon, "photogallery-popup__close")} onClick={closePopup}>
                            <SVG id="close" width={20} height={20} />
                        </div>
                    ...
                    <div className="photogallery-popup__footer">
                        <div>
                            <svg
                                width="37"
                                height="37"
                                ...
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                                className={`photogallery-popup__arrow ${activeButtonBigPhotoLeft ? "photogallery__button_active" : ""}`}
                        ...
                        <p className="photogallery-popup__description">{bigPhoto.description}</p>
                        <div>
                            <svg
                                width="37"
                                height="37"
                                ...
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                                className={`photogallery-popup__arrow ${activeButtonBigPhotoRight ? "photogallery__button_active" : ""}`}
